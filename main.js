...
var LANG = 'java';
var info;
var TIMER = 'm_timer.get()', DRIVER = 'm_robotDrive.tankDrive', POWER = 1,
...
function generateJavaArc(arc){
  ...
  let code = '';
  if(LANG == 'java'){
  code = `${ELSENEEDED?'else ':''}if(${TIMER} < ${TIME.toFixed(8)}){ // curve radius ${pixToFt(arc.radius).toFixed(1)}' for ${timeTaken.toFixed(1)}s
  ${DRIVER}(${x},${y});
}
`;
} else if(LANG = 'python'){
  code = `${ELSENEEDED?'elif ':'if'}(${TIMER} < ${TIME.toFixed(8)}): # curve radius ${pixToFt(arc.radius).toFixed(1)}' for ${timeTaken.toFixed(1)}s
  ${DRIVER}(${x},${y})\n
`;
}
ELSENEEDED = true;
...
//   let code = '';
//   if(LANG == 'java'){
//   code = `${ELSENEEDED?'else ':''}if(${TIMER} < ${TIME.toFixed(5)}){ // turn ${angledeg.toFixed(2)}&deg (${timeTaken.toFixed(1)}s)
//   ${DRIVER}(${x},${y});
// }
// `;
// }else if(LANG == 'python'){
// code = `${ELSENEEDED?'elif ':'if'}(${TIMER} < ${TIME.toFixed(5)}): # turn ${angledeg.toFixed(2)}&deg (${timeTaken.toFixed(1)}s)
//   ${DRIVER}(${x},${y})\n
// `;
// }
// ELSENEEDED = true;
...
if(LANG == 'java'){
code = `
turnByDegrees(${angledeg.toFixed(2)});
`;
}
ELSENEEDED = true;
return code;
...
//   let code = '';
//   if(LANG == 'java'){
//   code = `${ELSENEEDED?'else ':''}if(${TIMER} < ${TIME.toFixed(5)}){ // move ${ft.toFixed(2)}' (${timeTaken.toFixed(1)}s)
//   ${DRIVER}(${x},${y});
// }
// `;
// }else if(LANG == 'python'){
//   code = `${ELSENEEDED?'elif ':'if'}(${TIMER} < ${TIME.toFixed(5)}): # move ${ft.toFixed(2)}' (${timeTaken.toFixed(1)}s)
//   ${DRIVER}(${x},${y})\n
// `;
// }
// ELSENEEDED = true;
...
if(LANG == 'java'){
code = `
driveForward(${timeTaken.toFixed(1)}); // move ${ft.toFixed(2)}' (${timeTaken.toFixed(1)}s)
`;
}
ELSENEEDED = true;
return code;
...
//   code = `else:
//   ${DRIVER}(0,0)
// #sequence generated by markskinnnew Date().toDateString();
//   if(waypoints.length < 2) return '';
//   let code = ''
//   if(LANG == 'java'){
//     code = `else{
...
// }
//   return code;er92.github.io/autoBot on ${date}`;
// }
//   return code;er92.github.io/autoBot on ${date}`;
// }
//   return code;er92.github.io/autoBot on ${date}`;
